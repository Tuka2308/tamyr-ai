...
/**
 * Имена с этим префиксом создаёт сквозной тест и он же их удаляет.
 * Открытое удаление в продукте с настоящими данными недопустимо, поэтому
 * DELETE ограничен только такими записями.
 */
...
/** Удаляет запись ученика. Используется только уборкой после сквозного теста. */
